...
`,1)[0];if(p=Z,this.options.pedantic&&(p=p.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  ")),V.test(p)||G.test(p)||q.test(p)||Q.test(n))break;if(p.search(/[^ ]/)>=x||!p.trim())l+=`
`+p.slice(x);else{if($||f.search(/[^ ]/)>=4||V.test(f)||G.test(f)||Q.test(f))break;l+=`
`+p}!$&&!p.trim()&&($=!0),o+=Z+`
...
`,Fe={__name:"github-vue",setup(a){const n=g(Ue);return(e,t)=>(y(),w("div",{innerHTML:b(n),class:"markdown"},null,8,Ze))}};const Oe=a=>(he("data-v-6cfb8ef7"),a=a(),pe(),a),Ne=Oe(()=>de("i",{class:"fa-solid fa-arrow-left"},null,-1)),Qe={key:0},Ve={key:1},Ge={key:2},Je={key:3},Ye={key:4},Ke={key:5},We={key:6},Xe={__name:"PostView",setup(a){let e=le().params.name;return(t,i)=>{const s=ae("router-link");return y(),w("div",null,[S(s,{to:"/",class:"link"},{default:ce(()=>[Ne,ue("Back")]),_:1}),b(e)=="grid"?(y(),w("div",Qe,[S($e)])):R("",!0),b(e)=="centering"?(y(),w("div",Ve,[S(Ie)])):R("",!0),b(e)=="mediaqueries"?(y(),w("div",Ge,[S(Ce)])):R("",!0),b(e)=="datetime"?(y(),w("div",Je,[S(je)])):R("",!0),b(e)=="tinymce"?(y(),w("div",Ye,[S(He)])):R("",!0),b(e)=="customemail"?(y(),w("div",Ke,[S(qe)])):R("",!0),b(e)=="githubvue"?(y(),w("div",We,[S(Fe)])):R("",!0)])}}},nt=oe(Xe,[["__scopeId","data-v-6cfb8ef7"]]);export{nt as default};
